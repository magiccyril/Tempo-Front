...
angular.module('tempoApp')
  ...
  .controller('MainCtrl', [
    '$scope',
    'CALENDAR_MIN_DATE',
    'divonaNgEdf.Forecast',
    'divonaNgEdf.Tempo',
    'divonaNgEdf.Ejp',
    'Settings',
    function ($scope, CALENDAR_MIN_DATE, Forecast, Tempo, EJP, Settings) {
      ...
      Forecast.fetch().then(function (data) {
        ...
        Settings.themeColor.set(data.today.tempo.raw);
        $scope.themeCss = Settings.themeCSS.set(data.today.tempo.raw);
      });
    }]);
